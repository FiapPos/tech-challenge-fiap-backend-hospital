...
public class ListarFeedbacksPorProfessorQuery {

    private final FeedbackRepository feedbackRepository;

    @Transactional(readOnly = true)
    public List<FeedbackResponseDTO> executar(Long professorId) {
        List<Feedback> feedbacks = buscarFeedbacksPorProfessor(professorId);
        return converterParaListaDTO(feedbacks);
    }

    private List<Feedback> buscarFeedbacksPorProfessor(Long professorId) {
