package com.fiap.techchallenge.usuario_service.infrastructure.kafka;

import com.fiap.techchallenge.usuario_service.core.dtos.evento.DadosAgendamento;
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.usuario-sucesso}")
    private String topicoUsuarioComSucesso;

    @Value("${spring.kafka.topic.usuario-falha}")
    ...
    @Bean
    public NewTopic criaTopicoDeUsuarioComSucesso() {
        return buildTopic(topicoUsuarioComSucesso);
    }

    @Bean
    public NewTopic criaTopicoDeUsuarioComFalha() {
