package com.fiap.techchallenge.appointment_service.configuration.kafka;
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.notifica-fim}")
    private String notificaTopicoFim;
    ...
    @Bean
    public NewTopic criaTopicoDeComecoSaga() {
        return buildTopic(comecaTopicoSaga);
    }

    @Bean
    public NewTopic criaTopicoDeFimSaga() {
        return buildTopic(notificaTopicoFim);
    }
}
